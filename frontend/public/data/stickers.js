const stickers = [
  ...
  },
  {
    ...
    text: 'Es la sede donde el boulé, el consejo, en las ciudades de la antigua Grecia, se reunía.',
    textColor: 'Black',
    position: [-0.875, -0.65, -0.25],
  },
  {
    ...
    text: 'Se trata de un gran porche con una larga y esbelta columnata, que se encuentra en el ágora y en otros espacios públicos de las ciudades de la antigua Grecia con el fin de proteger a los peatones de las condiciones climatológicas. Además de ofrecer refugio para las tiendas y el libre comercio entre los ciudadanos.',
    textColor: 'Black',
    position: [-0.875, 0.35, -0.25],
  },
  {
